...
def lanca_estoque_produto_servico(id_produto_servico, ds_produto_servico, ds_categoria, qt_estoque, vl_unitario_produto_compra, vl_unitario_produto_venda):
    url = f"{base}/lanca_estoque_produto_servico/{id_produto_servico}"
