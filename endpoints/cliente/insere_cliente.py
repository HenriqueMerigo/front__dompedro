...
def insere_cliente(ds_cliente, ds_contato, dh_primeiro_agendamento, dh_ultimo_agendamento):
    url = f"{base}/insere_cliente"
    ...
    if not ds_cliente or not ds_contato or not dh_prim_str or not dh_ult_str:
